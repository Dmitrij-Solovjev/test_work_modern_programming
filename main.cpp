...
//    this_thread::sleep_for(20ms);
    ...
    //TODO !TODO
    // Я так же установил lock_guard при удалении массива, т.к. обращение все еще возможно из thread
    // (но это ничего не меняло.)
    // (Так же я заметил, что код, модифицированный вами по статистике работает менее удачно 50/50)
    // гайд где нашел пример с deadlock https://habr.com/ru/post/182610/
